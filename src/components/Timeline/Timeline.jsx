    ...
    <div className="container">
      ...
      <div className="row align-items-center how-it-works">
        <div className="col-2 text-center bottom">
          <div className="circle">10 年</div>
        </div>
        <div className="col-10">
          <p>入七玄门，成为墨大夫弟子，修炼《长春功》，偶得神秘小瓶。</p>
        </div>
      </div>
      {/* <!--path between 1-2--> */}
      ...
      <div className="row align-items-center justify-content-end how-it-works">
        <div className="col-10 text-right">
          <p>
            识厉飞雨，救其性命
            <br />
            因首次出手救人的不良后果，直接导致了以后无利不起早的“恶习”，为其调配减轻痛苦的灵药；
            <br />
            意外发现神秘液体的功效
            <br />
            炼丹服食，修炼至《长春功》第四层，五官敏感度有了质的变化
            <br />
            张铁以“曲魂”面貌登场
            <br />
            墨大夫露出獠牙。
